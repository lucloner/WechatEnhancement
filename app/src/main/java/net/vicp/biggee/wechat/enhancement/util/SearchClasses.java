package net.vicp.biggee.wechat.enhancement.util;
...
import net.vicp.biggee.wechat.enhancement.Main;
...
import static net.vicp.biggee.wechat.enhancement.util.ReflectionUtil.log;
