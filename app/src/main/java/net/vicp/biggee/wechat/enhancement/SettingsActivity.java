        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            show_icon.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object isChecked) {
                    ...
                    packageManager.setComponentEnabledSetting(new ComponentName(getActivity(), "net.vicp.biggee.wechat.enhancement.SettingsActivity_Alias"), status, PackageManager.DONT_KILL_APP);
                    return true;
                }
            });
